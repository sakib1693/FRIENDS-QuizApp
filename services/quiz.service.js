...
(function () {
    ...
    var quizQuestions  = [
        ...
        {
            type: "text",
            text: "What did Phoebe dress up as on Halloween?",
            possibilities: [
                {
                    answer: "Super girl"
                },
        ...
        },
        {
            ...
            possibilities: [
                ...
                {
                    answer: "The left fuselage"
                },
                {
                    answer: "The left phalange"
                },
                {
        ...
        {
            type: "text",
            text: "How does Monica and Rachel cover Ben's head bump?",
            possibilities: [
                {
                    answer: "With a damp toilet paper"
                },
                {
                    answer: "Hide him"
                },
                {
                    answer: "With a red hoodie"
                },
                {
                    answer: "With a teddy bear outfit"
                }
            ],
            selected: null,
            correct: null
        ...
        {
            type: "text",
            text: "What is Chandler and Joey's favourite show?",
            possibilities: [
                {
                    answer: "Bay watch"
                },
